...
# Recent Updates:
+ We use pretrained ViT-Small as initialization for the student model and it achieves even better results(2 points higher Hit@1) than thr previous Deit-small-distilled model. Link of the jit scirpt checkpoint is [here](https://drive.google.com/file/d/1s_oX0-HIELpjjrBXsjlofIbTGZ_Wllo0/view?usp=sharing).
